<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="softwareEdit.aspx.cs" Inherits="admin_pages_softwareEdit" %>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-pills">
                                <li class="active">
                                    <a data-toggle="pill" href="#UploadIconImage">上传文件</a>
                                </li>
                                <li>
                                    <a data-toggle="pill" href="#IconImageGallary">媒体库</a>
                                </li>
                            </ul>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-pills">
                                <li class="active">
                                    <a data-toggle="pill" href="#UploadScreenShotsImage">上传文件</a>
                                </li>
                                <li>
                                    <a data-toggle="pill" href="#ScreenShotsImageGallary">媒体库</a>
                                </li>
                            </ul>
                            <div class="tab-content">
