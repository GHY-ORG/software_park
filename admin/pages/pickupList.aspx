...
<asp:Content ContentPlaceHolderID="body" runat="server">
    ...
    <SoftwarePark:Pager ID="Pager" runat="server" DatabaseTable="Pickup" PageSize="20" SQLCondition="" SQLOrder="ORDER BY ID" OnPageIndexChanged="Pager_OnPageIndexChanged" />
</asp:Content>