<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bannerEdit.aspx.cs" Inherits="admin_pages_bannerEdit" %>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-pills">
                                <li class="active"><a data-toggle="pill" href="#UploadBannerImage">上传文件</a></li>
                                <li><a data-toggle="pill" href="#BannerImageGallary">媒体库</a></li>
                            </ul>
