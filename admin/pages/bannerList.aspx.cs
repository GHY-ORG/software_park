...
public partial class admin_pages_bannerList : System.Web.UI.Page
{
    string selVal = "";
    ...
    protected void DataList1_DeleteCommand(object source, DataListCommandEventArgs e)
    {
        ...
        string strSQL = "DELETE FROM Banner WHERE ID= @ID";
    ...
    {
        string strSQL = "SELECT COUNT(*) FROM Banner " + selVal;
    ...
    ICollection CreateSource()
    {
        ...
        string strSQL = "SELECT * FROM Banner " + selVal;
    ...
    protected void SearchBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            selVal = "WHERE Description like '%" + SearchContent + "%'";
        }
        else
        {
            selVal = "";
