...
<asp:Content ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="/Statics/css/pickupDetail.min.css?v=20171102" />
</asp:Content>
        ...
        <div class="container">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <a href="/pages/pickupDetail.aspx?id=<%=PickupID %>">P!CK</a>
                    </li>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <asp:LinkButton ID="UpvoteLinkBtn" runat="server" CssClass="btn btn-primary" OnClick="UpvoteLinkBtn_Click">
